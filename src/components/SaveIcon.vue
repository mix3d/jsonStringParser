...
<script>
//Completely empty template. Couldn't find a better way to inline SVGs without a TON of work or without live template compiling, which Vue complained about not doing in production mode.
export default { }
</script>
